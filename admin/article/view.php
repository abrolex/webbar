		...
		else
		{
			if(preg_match('/[^0-9]/',$_GET['article_id']) == 0)
			{
				...
				else
				{
					...
					{
						$output .= '<p><a class="w3-btn w3-padding-large blue" href="del.php?article_id='.$row['article_id'].'">entfernen <i class="fas fa-times"></i></a></p>';
...
<html lang="de">
	...
	<body class="gradient-blue">
		...
		<script type="text/javascript" src="/js/admin_article_view.js"></script>
	</body>
</html>